...
col1 <- c("AN1A", "AN1B", "AN1C", "AN2A", "AN2B", "AN2C", "AN3A", "AN3B", "AN3C")
...
#### AN1A: Mild anaemia in children 6-59 months

Indicator **AN1A** is TRUE if either...

* **AGE** of respondent is between 6-59 months old ***and***

     * **ALTITUDE** is ***<*** 1000 metres ***and*** **HB** is ***$\geq$*** 100 g/L ***and*** **HB** is ***$\leq$*** 109 g/L; ***or***,
     ...
     * **ALTITUDE** is ***=*** 4500 metres ***and*** **HB** is ***$\geq$*** 145 g/L ***and*** **HB** is ***$\leq$*** 154 g/L.
...
Indicator **AN1C** is TRUE if either...
...
Indicator **AN2A** is TRUE if either...
...
* **AGE** of respondent is between 6-59 months old ***and***
     ...
     * **ALTITUDE** is ***=*** 4500 metres ***and*** **HB** is ***$\geq$*** 115 g/L ***and*** ***$\leq$*** 144 g/L.
...
Indicator **AN2C** is TRUE if either...
...
Indicator **AN3A** is TRUE if either...
...
* {(**AGE** of respondent is between 6-59 months old) ***or*** (**AGE** of respondent is between 15 and 49 years old ***and*** **SEX** is **FEMALE** ***and*** **PREGNANT**)} ***and***
     ...
     * **ALTITUDE** is ***=*** 4500 metres ***and*** **HB** is ***<*** 115 g/L.
...
#### AN3C: Severe anaemia in pregnant carers

Indicator **AN3C** is TRUE if either...
...
The indicator IR1A is TRUE if either...

* **AGE** of respondent is between 6-59 months old ***and*** 

     * **CRP** ***$\leq$*** 5 mg/L ***and*** serum **FERRITIN** is ***<*** 12 µg/L; or,
     
     * **CRP** > 5 mg/L ***and*** serum **FERRITIN** is ***<*** 19.8 µg/L.
...
The indicator **IR2A** is TRUE if either...
...
The indicator **IR2B** is TRUE if either...
...
Acute inflammation indicators are:
...
Acute inflammation (AI) indicators require **AGE** and **PREGNANCY** status and serum **CRP** concentration.

### AI1: Acute inflammation in children 6-59 months

The indicator AI1 is TRUE if **AGE** is between 6 and 59 months **and** **CRP** is > 5 mg/L.

### AI2: Acute inflammation in non-pregnant carers

The indicator AI2 is TRUE if **AGE** is between 15 and 49 year ***and*** **NOT PREGNANT** and **CRP** is > 5 mg/L.

### AI3: Acute inflammation in pregnant carers

The indicator AI3 is TRUE if **AGE** is between 15 and 49 year ***and*** **PREGNANT** and **CRP** is > 5 mg/L.
