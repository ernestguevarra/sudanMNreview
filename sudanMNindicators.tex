...
\caption{\label{tab:indicators}List of proposed indicators for Sudan Micronutrient Survey}
\centering
\resizebox{\linewidth}{!}{
\begin{tabular}[t]{lll}
\toprule
...
\midrule
\rowcolor{gray!6}   & Mean haemoglobin in children 6-59 months old & Mean\\
\cmidrule{2-3}
 & Mild anaemia in children 6-59 months old & Proportion\\
\cmidrule{2-3}
\rowcolor{gray!6}   & Moderate anaemia in children 6-59 months old & Proportion\\
\cmidrule{2-3}
 & Severe anaemia in children 6-59 months old & Proportion\\
\cmidrule{2-3}
\rowcolor{gray!6}   & Mean haemoglobin in non-pregnant women of reproductive age & Mean\\
\cmidrule{2-3}
 & Mild anaemia in non-pregnant women of reproductive age & Proportion\\
\cmidrule{2-3}
\rowcolor{gray!6}   & Moderate anaemia in non-pregnant women of reproductive age & Proportion\\
\cmidrule{2-3}
 & Severe anaemia in non-pregnant women of reproductive age & Proportion\\
\cmidrule{2-3}
\rowcolor{gray!6}   & Mean haemoglobin in pregnant women & Mean\\
\cmidrule{2-3}
 & Mild anaemia in pregnant women & Proportion\\
\cmidrule{2-3}
\rowcolor{gray!6}   & Moderate anaemia in pregnant women & Proportion\\
\cmidrule{2-3}
\multirow[t]{-12}{*}{\raggedright\arraybackslash Anaemia} & Severe anaemia in pregnant women & Proportion\\
\cmidrule{1-3}
\rowcolor{gray!6}   & Mean serum ferritin in children 6-59 months old & Mean\\
\cmidrule{2-3}
 & Mean serum ferritin in non-pregnant women of reproductive age & Mean\\
\cmidrule{2-3}
\rowcolor{gray!6}   & Mean serum ferritin in pregnant women & Mean\\
\cmidrule{2-3}
 & Iron-deficient children 6-59 months old & Proportion\\
\cmidrule{2-3}
\rowcolor{gray!6}   & Iron-deficient non-pregnant women of reproductive age & Proportion\\
\cmidrule{2-3}
